...
<head>
    ...
    <title>Register Anonim - Curhatin</title>
...
<body>
    <div class="page">
        <div class="card">
            <div class="left">
                <form class="form" method="POST" action="{{ route('register.anonim.post') }}">
                    @csrf
                    <div class="title">Register Anonim</div>
                    <div class="subtitle">Daftar sebagai pengguna anonim</div>
                    ...
                    <button type="submit" class="button">Daftar Anonim</button>
